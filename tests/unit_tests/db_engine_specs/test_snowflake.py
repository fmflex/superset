...
def test_adjust_engine_params_fully_qualified() -> None:
    ...
    assert uri.render_as_string(hide_password=False) == "snowflake://user:pass@account/database_name/default"
    ...
    assert uri.render_as_string(hide_password=False) == "snowflake://user:pass@account/database_name/new_schema"
    ...
    assert uri.render_as_string(hide_password=False) == "snowflake://user:pass@account/new_catalog/default"
    ...
    assert uri.render_as_string(hide_password=False) == "snowflake://user:pass@account/new_catalog/new_schema"
...
def test_adjust_engine_params_catalog_only() -> None:
    ...
    uri = SnowflakeEngineSpec.adjust_engine_params(url, {})[0]
    assert uri.render_as_string(hide_password=False) == "snowflake://user:pass@account/database_name"
    ...
    assert uri.render_as_string(hide_password=False) == "snowflake://user:pass@account/new_catalog"
