...
def pessimistic_connection_handling(some_engine: Engine) -> None:
    # In SQLAlchemy 2.0, pool_pre_ping=True is the recommended way to handle
    # pessimistic disconnect detection. The engine_connect event no longer
    # supports running queries without interfering with transaction state.
    # This function now only handles the SQLite pragma setup below.
